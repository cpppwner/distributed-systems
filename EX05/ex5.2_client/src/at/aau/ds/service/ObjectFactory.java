 ...
 * generated in the at.aau.ds.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://ds.aau.at/", "add");
    private final static QName _AddResponse_QNAME = new QName("http://ds.aau.at/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://ds.aau.at/", "multiplyResponse");
    private final static QName _Subtract_QNAME = new QName("http://ds.aau.at/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://ds.aau.at/", "subtractResponse");
    private final static QName _Divide_QNAME = new QName("http://ds.aau.at/", "divide");
    private final static QName _DivideResponse_QNAME = new QName("http://ds.aau.at/", "divideResponse");
    private final static QName _Multiply_QNAME = new QName("http://ds.aau.at/", "multiply");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: at.aau.ds.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ds.aau.at/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ds.aau.at/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ds.aau.at/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ds.aau.at/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ds.aau.at/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ds.aau.at/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ds.aau.at/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ds.aau.at/", name = "multiply")
